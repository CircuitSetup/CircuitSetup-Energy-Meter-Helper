...
export function ctInventoryStep(
  ...
  return html`
    <section class="step-content ct-step" aria-labelledby="step-heading">
      ...
      ${configuration && totals ? defaultTotalsSection(configuration, totals, nativeTotalsReadable, nativeTotalsWritable, updateConfiguration, nativeGraphState, meterInventory?.capabilities.reason_codes) : nothing}
