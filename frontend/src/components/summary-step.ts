...
export function summaryOutcome(input: SummaryOutcomeInput): SummaryOutcome {
  ...
  if (input.completedWithoutChanges) return { heading, configurationStatus: input.verifiedConfiguration ? "Helper-managed configuration was left unchanged." : "Configuration was left unchanged.", migrationStatus: migrated ? "Migration installed." : null, calibrationStatus: "Existing calibration was kept unchanged.", authorityMessage: "No restart-verified calibration record was required.", warnings };
