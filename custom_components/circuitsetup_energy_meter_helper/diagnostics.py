...
def _error_code(error: object) -> str:
    ...
    return {
        ...
        "MeterCommunicationError": "meter_communication_failed",
        "OffsetChipIdentityUnavailable": "offset_chip_identity_unavailable",
        "OffsetDiagnosticsIncomplete": "offset_diagnostics_incomplete",
        "OffsetTablesUnavailable": "offset_tables_unavailable",
