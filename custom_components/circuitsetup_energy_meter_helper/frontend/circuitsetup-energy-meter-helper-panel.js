const F = globalThis, oe = F.ShadowRoot && (F.ShadyCSS === void 0 || F.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, re = /* @__PURE__ */ Symbol(), fe = /* @__PURE__ */ new WeakMap();
let Ne = class {
  constructor(e, t, i) {
...
const { is: Fe, defineProperty: We, getOwnPropertyDescriptor: Ke, getOwnPropertyNames: Je, getOwnPropertySymbols: Ze, getPrototypeOf: Ye } = Object, Y = globalThis, ve = Y.trustedTypes, Xe = ve ? ve.emptyScript : "", Qe = Y.reactiveElementPolyfillSupport, B = (n, e) => n, se = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Xe : null;
      break;
...
const ae = globalThis, be = (n) => n, K = ae.trustedTypes, $e = K ? K.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, Ue = "$lit$", I = `lit$${Math.random().toFixed(9).slice(2)}$`, Pe = "?" + I, et = `<${Pe}>`, O = document, q = () => O.createComment(""), H = (n) => n === null || typeof n != "object" && typeof n != "function", ce = Array.isArray, tt = (n) => ce(n) || typeof n?.[Symbol.iterator] == "function", te = `[\x20\t
\f\r]`, D = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ye = /-->/g, we = />/g, T = RegExp(`>|${te}(?:([^\\s"'>=/]+)(${te}*=${te}*(?:[^\x20\t
\f\r"'\`<>=]|("|')|))|$)`, "g"), Se = /'/g, xe = /"/g, De = /^(?:script|style|textarea|title)$/i, it = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), l = it(1), U = /* @__PURE__ */ Symbol.for("lit-noChange"), y = /* @__PURE__ */ Symbol.for("lit-nothing"), Ce = /* @__PURE__ */ new WeakMap(), R = O.createTreeWalker(O, 129);
function je(n, e) {
...
const st = (n, e) => {
  ...
  for (let a = 0; a < t; a++) {
    const c = n[a];
    let u, p, d = -1, h = 0;
    for (; h < c.length && (r.lastIndex = h, p = r.exec(c), p !== null); ) h = r.lastIndex, r === D ? p[1] === "!--" ? r = ye : p[1] !== void 0 ? r = we : p[2] !== void 0 ? (De.test(p[2]) && (s = RegExp("</" + p[2], "g")), r = T) : p[3] !== void 0 && (r = T) : r === T ? p[0] === ">" ? (r = s ?? D, d = -1) : p[1] === void 0 ? d = -2 : (d = r.lastIndex - p[2].length, u = p[1], r = p[3] === void 0 ? T : p[3] === '"' ? xe : Se) : r === xe || r === Se ? r = T : r === ye || r === we ? r = D : (r = T, s = void 0);
    const g = r === T && n[a + 1].startsWith("/>") ? " " : "";
    o += r === D ? c + et : d >= 0 ? (i.push(u), c.slice(0, d) + Ue + c.slice(d) + I + g) : c + I + (d === -2 ? a : g);
  }
...
class z {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let o = 0, r = 0;
    const a = e.length - 1, c = this.parts, [u, p] = st(e, t);
    if (this.el = z.createElement(u, i), R.currentNode = this.el.content, t === 2 || t === 3) {
      const d = this.el.content.firstChild;
      d.replaceWith(...d.childNodes);
    }
    for (; (s = R.nextNode()) !== null && c.length < a; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const d of s.getAttributeNames()) if (d.endsWith(Ue)) {
          const h = p[r++], g = s.getAttribute(d).split(I), f = /([.?@])?(.*)/.exec(h);
        ...
        if (De.test(s.tagName)) {
          const d = s.textContent.split(I), h = d.length - 1;
          if (h > 0) {
            s.textContent = K ? K.emptyScript : "";
            for (let g = 0; g < h; g++) s.append(d[g], q()), R.nextNode(), c.push({ type: 2, index: ++o });
            s.append(d[h], q());
          }
        }
...
class V {
  ...
  _$AI(e, t = this) {
    e = P(this, e, t), H(e) ? e === y || e == null || e === "" ? (this._$AH !== y && this._$AR(), this._$AH = y) : e !== this._$AH && e !== U && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : tt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== y && H(this._$AH) ? this._$AA.nextSibling.data = e : this.T(O.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    const { values: t, _$litType$: i } = e, s = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = z.createElement(je(i.h, i.h[0]), this.options)), i);
  ...
  _$AC(e) {
    ...
    return t === void 0 && Ce.set(e.strings, t = new z(e)), t;
  }
  k(e) {
...
class X {
  ...
  _$AI(e, t = this, i, s) {
    ...
    let r = !1;
    if (o === void 0) e = P(this, e, t, 0), r = !H(e) || e !== this._$AH && e !== U, r && (this._$AH = e);
    else {
      const a = e;
      let c, u;
      for (e = o[0], c = 0; c < o.length - 1; c++) u = P(this, a[i + c], t, c), u === U && (u = this._$AH[c]), r ||= !H(u) || u !== this._$AH[c], u === y ? e = y : e !== y && (e += (u ?? "") + o[c + 1]), this._$AH[c] = u;
    }
    r && !s && this.j(e);
  }
  j(e) {
...
function Be(n, e) {
  const t = b(n, e);
  v(t.entry_id, e), v(t.title, e), v(t.project_name, e), v(t.project_version, e, !0), A(t.importable, e, !0), v(t.configuration, e, !0);
}
function L(n, e) {
  const t = b(n, e);
  if (S(t.state, _t, e), w(t.devices, e).forEach((i) => Be(i, e)), t.configuration_authoritative !== void 0 && A(t.configuration_authoritative, e), t.installer_intent !== void 0) {
...
function Te(n, e) {
  ...
  const c = a.map((u) => {
    const p = b(u, e), d = S(p.source, Ae, e), h = m(p.addon_count, e);
    if (h < 0 || h > 6) throw new Error(`${e} response is invalid`);
    return v(p.detail, e), d;
  });
...
function Et(n, e) {
  const t = b(n, e);
  return "topology" in t ? (Te(t.topology, e), t.configuration_authoritative !== void 0 && A(t.configuration_authoritative, e), n) : Te(n, e);
}
function It(n, e) {
  const t = b(n, e);
  ...
  i.forEach((r, a) => {
    ...
    v(c.name, e), m(c.raw_gain_ct, e), C(c.reporting_multiplier, e), ne(c.selected_model_id, e), A(c.selection_verified_against_config, e), ne(c.display_label, e);
    const p = b(c.address, e), d = m(p.channel, e), h = m(p.board_index, e), g = m(p.group_index, e), f = S(p.phase, J, e), $ = a + 1;
    if (u !== $ || d !== $ || h !== Math.floor(a / 6) || g !== Math.floor(a % 6 / 3) + 1 || f !== ["A", "B", "C"][a % 3]) throw new Error(`${e} response is invalid`);
  });
  ...
  return o.forEach((r) => {
    const a = b(r, e);
    v(a.model_id, e), v(a.label, e), C(a.rated_current_a, e), v(a.secondary, e), a.default_gain_ct !== null && m(a.default_gain_ct, e), A(a.requires_burden_jumper_cut, e), v(a.notes, e);
  }), n;
}
function ie(n, e) {
  const t = b(n, e);
  if (v(t.transaction_id, e), S(t.state, vt, e), v(t.source_sha256, e), A(t.rollback_available, e), v(t.redacted_diff, e), w(t.changes, e).forEach((i) => {
...
function j(n, e) {
  const t = b(n, e);
  v(t.session_id, e), v(t.device_id, e), S(t.state, mt, e), A(t.safety_acknowledged, e);
...
function Tt(n, e, t, i) {
  ...
  const c = a.map((u) => {
    const p = b(u, e), d = w(p.samples, e, 3).map((k) => C(k, e));
    if (d.length !== 3) throw new Error(`${e} response is invalid`);
    const h = C(p.mean, e), g = C(p.standard_deviation, e), f = C(p.range_percent, e), $ = d.reduce((k, E) => k + E, 0) / d.length, _ = Math.sqrt(d.reduce((k, E) => k + (E - $) ** 2, 0) / d.length), x = 100 * (Math.max(...d) - Math.min(...d)) / Math.abs($);
    if (!W(h, $) || !W(g, _) || !W(f, x)) throw new Error(`${e} response is invalid`);
    return f;
  });
...
function Rt(n, e, t) {
  ...
  u.forEach((h, g) => {
    const f = b(h, e), $ = S(f.phase, J, e);
    if ($ !== ["A", "B", "C"][g]) throw new Error(`${e} response is invalid`);
    C(f.measured_voltage, e), C(f.measured_current, e);
    const _ = C(f.reference_voltage, e), x = C(f.reference_current, e), k = m(f.old_voltage_gain, e), E = m(f.new_voltage_gain, e), Q = m(f.old_current_gain, e), ee = m(f.new_current_gain, e);
    if ([k, E, Q, ee].some((ge) => ge < 1 || ge > 65535)) throw new Error(`${e} response is invalid`);
    if (t.target === "voltage") {
    ...
    } else if (Math.abs(_) > 1e-6 || ($ === c ? Math.abs(x - t.rawReference) > Math.max(1e-4, 1e-6 * Math.max(Math.abs(x), t.rawReference)) : Math.abs(x) > 1e-6) || k !== E || $ !== c && Q !== ee) throw new Error(`${e} response is invalid`);
  });
  const p = w(i.register_mismatch_phases, e, 3);
  p.forEach((h) => S(h, J, e));
  const d = w(i.matching_lines, e, 100);
  if (d.length === 0 || d.some((h) => typeof h != "string") || A(i.flash_saved, e) !== !0 || p.length !== 0 || A(i.calibration_disabled, e) !== !1) throw new Error(`${e} response is invalid`);
}
function Ot(n) {
...
function Nt(n, e, t) {
  ...
  if (S(i.source_authority, /* @__PURE__ */ new Set(["saved_flash"]), e), A(i.source_handoff_available, e), ne(i.source_handoff_transaction_id, e), !Ct.test(i.mac) || !At.test(i.config_filename) || !kt.test(i.config_sha256) || !Ee.test(i.verification_id) || o < 1 || i.source_handoff_transaction_id !== null && !Ee.test(i.source_handoff_transaction_id) || s !== t.addon_count || i.topology_project_name !== t.project_name || i.topology_connection_type !== t.connection_type || i.topology_voltage_layout !== t.voltage_layout) throw new Error(`${e} response is invalid`);
  const r = w(i.groups, e, 14), a = /* @__PURE__ */ new Set(["meter_main1", "meter_main2", ...Array.from({ length: s }, (u, p) => [`addon${p + 1}_1`, `addon${p + 1}_2`]).flat()]), c = /* @__PURE__ */ new Set();
  if (r.length < 1) throw new Error(`${e} response is invalid`);
  return r.forEach((u) => {
    const p = b(u, e), d = v(p.instance_id, e);
...
`) || e.includes("\r"), a = s === "redacted_diff" ? 32768 : 4096;
  ...
  async call(e, t, i = {}) {
    ...
    return Z.assertPublicPayload(s, Ie.has(e)), t(s);
  }
  subscribe(e, t, i, s) {
    return this.hass.connection.subscribeMessage((o) => {
      Z.assertPublicPayload(o, Ie.has(e)), s(i(o));
...
function Bt(n, e, t, i, s, o, r, a, c) {
  const u = Math.ceil(n.channels.length / 6), p = n.channels.filter((d) => d.address.board_index === e).slice(0, 8);
  return l`
    <section class="step-content ct-step" aria-labelledby="step-heading">
      ...
      <div class="ct-table" role="table" aria-rowcount=${n.channels.length}>
        ...
        <div class="ct-window" aria-label="Current transformers">
          ${p.map((d) => {
    const h = i.get(d.channel) ?? {
      name: d.name,
      modelId: d.selected_model_id ?? "",
      multiplier: d.reporting_multiplier,
      burdenAcknowledged: !1,
      expanded: !1
    }, g = n.catalog.presets.find((_) => _.model_id === h.modelId), f = Dt(g, h.multiplier, h.modelId === "custom" ? h.customGainCt : void 0), $ = he(d, h);
    return l`
              <div class="ct-row" data-ct-row data-ct-group=${d.address.group_index - 1} role="row" aria-label=${`CT${d.channel}`}>
                <label><span class="mobile-label">Name</span><input aria-label=${`CT${d.channel} name`} .value=${h.name}
                ...
                <label><span class="mobile-label">Model</span><select aria-label=${`CT${d.channel} model`}
                  @change=${(_) => {
      const x = _.target.value, k = n.catalog.presets.find((E) => E.model_id === x);
      r(d.channel, {
        modelId: x,
        burdenAcknowledged: d.selection_verified_against_config && x === d.selected_model_id && (x === "custom" || k?.requires_burden_jumper_cut === !0),
        expanded: !0
      });
    }}>
                ...
                <label><span class="mobile-label">Multiplier</span><input type="number" min="0.001" step="0.001" aria-label=${`CT${d.channel} multiplier`}
                  .value=${String(h.multiplier)} @input=${(_) => r(d.channel, { multiplier: Number(_.target.value) })} /></label>
                ...
                <button class="row-toggle" aria-expanded=${h.expanded} @click=${() => r(d.channel, { expanded: !h.expanded })}>
                  ${h.modelId ? $ ? "Changed" : "OK" : "Choose model"}
                </button>
              </div>
              ${h.modelId === "custom" ? l`<div class="ct-detail custom-fields">
                ...
                <label>Custom label <input maxlength="64" aria-label=${`CT${d.channel} custom label`} .value=${h.customLabel ?? ""}
              ...
              ${g && g.rated_current_a > 65.535 && h.multiplier === 1 ? l`<div class="warning-band" role="status">CT${d.channel}: rated current exceeds the unscaled 65.535 A register range.</div>` : y}
              ${h.expanded && g ? l`
                <dl class="ct-detail">
      ...
      <footer class="action-footer">
        ...
        <button class="primary" ?disabled=${!Ht(n, i)} @click=${c}>Review changes</button>
      </footer>
    </section>
  `;
}
...
function zt(n, e, t, i, s, o, r, a, c, u, p, d) {
  const h = n?.ct_count ?? e?.channels.length ?? 6, g = Math.floor((t - 1) / 6), f = g * 6 + 1;
  return l`
    <section class="step-content calibration-step" aria-labelledby="step-heading">
      <div class="board-tabs" role="tablist" aria-label="Calibration boards">
        ${Array.from({ length: Math.ceil(h / 6) }, ($, _) => l`<button role="tab" aria-selected=${_ === g} @click=${() => r(_ * 6 + 1)}>${_ === 0 ? "Main Board" : `Add-on ${_}`}</button>`)}
      </div>
      <div class="group-grid">
        ${[0, 3].map(($) => l`<section><h2>Group ${g * 2 + $ / 3 + 1}</h2>${Array.from({ length: 3 }, (_, x) => {
    const k = f + $ + x;
    return l`<button class=${k === t ? "selected" : ""} @click=${() => r(k)}>CT${k}</button>`;
  })}</section>`)}
      </div>
      ...
      ${o?.state.includes("indeterminate") ? l`<aside class="recovery-panel" role="status"><strong>Calibration outcome indeterminate</strong><p>No automatic retry will be made.</p><button class="secondary" @click=${p}>Reconnect and inspect</button><button class="danger" @click=${d}>Cancel session</button></aside>` : ""}
    </section>
  `;
}
  ...
  return l`
    <details>
      ...
      <div class="technical-grid">
        ...
        <section><h3>Sample windows by target</h3>${[...i.entries()].map(([r, a]) => l`<div data-target=${r}>${pe(a)}</div>`) || "No sample evidence."}</section>
...
function Yt(n, e, t, i, s, o, r, a, c, u, p) {
  const d = n?.group_count ?? 2;
  return l`
    <section class="step-content calibration-step" aria-labelledby="step-heading">
      <div class="target-tabs" role="tablist" aria-label="Voltage groups">
        ${Array.from({ length: d }, (h, g) => l`<button role="tab" aria-selected=${g === e} @click=${() => o(g)}>Group ${g + 1}</button>`)}
      </div>
      ...
      ${s?.state === "indeterminate" ? l`<aside class="recovery-panel" role="status"><strong>Calibration outcome indeterminate</strong><p>No automatic retry will be made.</p><button class="secondary" @click=${u}>Reconnect and inspect</button><button class="danger" @click=${p}>Cancel session</button></aside>` : ""}
    </section>
  `;
}
const Xt = Ve`
...
class Qt extends G {
  ...
  showTopology(e) {
    this.topology = e, this.navigate("topology"), this.error = He(e) || e.project_name !== this.selectedProjectName() ? "Topology mismatch" : "", this.requestUpdate();
  }
  showInventory(e) {
  ...
  async reviewChanges() {
    ...
    const e = Gt(this.inventory, this.drafts);
  ...
  stepBody() {
    return this.step === "setup" ? Kt(
      ...
      !!this.error
    ) : this.step === "ct" && this.inventory ? Bt(
      this.inventory,
      this.board,
      this.ctGroup,
      this.drafts,
      ...
      <footer class="action-footer"><button class="secondary" @click=${() => this.back()}>Back</button><button class="primary" @click=${() => this.navigate("current")}>Continue</button></footer>` : this.step === "current" ? l`${zt(
      this.topology,
      this.inventory,
      this.channel,
      this.reference,
