...
const { is: ii, defineProperty: si, getOwnPropertyDescriptor: ni, getOwnPropertyNames: ri, getOwnPropertySymbols: oi, getPrototypeOf: ai } = Object, ke = globalThis, et = ke.trustedTypes, ci = et ? et.emptyScript : "", li = ke.reactiveElementPolyfillSupport, de = (n, e) => n, Pe = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? ci : null;
      break;
  ...
  return t;
} }, kt = (n, e) => !ii(n, e), tt = { attribute: !0, type: String, converter: Pe, reflect: !1, useDefault: !1, hasChanged: kt };
...
re.elementStyles = [], re.shadowRootOptions = { mode: "open" }, re[de("elementProperties")] = /* @__PURE__ */ new Map(), re[de("finalized")] = /* @__PURE__ */ new Map(), li?.({ ReactiveElement: re }), (ke.reactiveElementVersions ??= []).push("2.1.2");
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), ot = /'/g, at = /"/g, xt = /^(?:script|style|textarea|title)$/i, pi = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), p = pi(1), Y = /* @__PURE__ */ Symbol.for("lit-noChange"), R = /* @__PURE__ */ Symbol.for("lit-nothing"), ct = /* @__PURE__ */ new WeakMap(), Q = te.createTreeWalker(te, 129);
function It(n, e) {
...
const ui = (n, e) => {
  ...
  for (let a = 0; a < t; a++) {
    const l = n[a];
    let c, u, d = -1, g = 0;
    for (; g < l.length && (o.lastIndex = g, u = o.exec(l), u !== null); ) g = o.lastIndex, o === ce ? u[1] === "!--" ? o = nt : u[1] !== void 0 ? o = rt : u[2] !== void 0 ? (xt.test(u[2]) && (s = RegExp("</" + u[2], "g")), o = X) : u[3] !== void 0 && (o = X) : o === X ? u[0] === ">" ? (o = s ?? ce, d = -1) : u[1] === void 0 ? d = -2 : (d = o.lastIndex - u[2].length, c = u[1], o = u[3] === void 0 ? X : u[3] === '"' ? at : ot) : o === at || o === ot ? o = X : o === nt || o === rt ? o = ce : (o = X, s = void 0);
    const b = o === X && n[a + 1].startsWith("/>") ? " " : "";
    r += o === ce ? l + di : d >= 0 ? (i.push(c), l.slice(0, d) + At + l.slice(d) + K + b) : l + K + (d === -2 ? a : b);
  }
...
class ge {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let r = 0, o = 0;
    const a = e.length - 1, l = this.parts, [c, u] = ui(e, t);
    ...
    for (; (s = Q.nextNode()) !== null && l.length < a; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const d of s.getAttributeNames()) if (d.endsWith(At)) {
          ...
          l.push({ type: 1, index: r, name: h[2], strings: b, ctor: h[1] === "." ? gi : h[1] === "?" ? _i : h[1] === "@" ? mi : Ae }), s.removeAttribute(d);
      ...
      } else if (s.nodeType === 8) if (s.data === Et) l.push({ type: 2, index: r });
      else {
        let d = -1;
...
class fi {
  ...
  u(e) {
    ...
    for (; l !== void 0; ) {
      if (o === l.index) {
        let c;
        l.type === 2 ? c = new _e(r, r.nextSibling, this, e) : l.type === 1 ? c = new l.ctor(r, l.name, l.strings, this, e) : l.type === 6 && (c = new vi(r, this, e)), this._$AV.push(c), l = i[++a];
      }
...
const lt = "circuitsetup_energy_meter_helper/", yi = /(?:^|_)(?:api_?key|contents?|credentials?|encryption(?:_key)?|logs?|noise_?psk|output_tail|password|prior(?:_content)?|proposed_content|raw(?:_logs?)?|secrets?|ssid|tokens?|yaml)(?:$|_)/i, Si = /(?:api[_ -]?key|password|secret|ssid|token)\s*[:=]/i, Ci = /[\u0000-\u0009\u000b\u000c\u000e-\u001f\u007f-\u009f]/, ki = /[\u0000-\u001f\u007f-\u009f]/, Ai = /* @__PURE__ */ new Set(["no_device", "installer_guide", "waiting_for_discovery", "device_discovered", "waiting_for_adoption", "reading_config", "topology_review", "ct_configuration", "config_review", "config_writing", "config_validating", "config_compiling", "waiting_for_install_confirmation", "config_installing", "waiting_for_reconnect", "ready_for_calibration", "failed"]), Ei = /* @__PURE__ */ new Set(["previewed", "write_confirmed", "written", "validated", "compiled", "install_confirmation_required", "installing", "reconnecting", "verified", "rolled_back", "failed"]), xi = /* @__PURE__ */ new Set(["safety_required", "preflight_failed", "ready", "stable", "unstable", "applied_pending_restart_verification", "result_outside_tolerance", "partial", "indeterminate", "verified", "cancelled"]), Ve = /* @__PURE__ */ new Set(["wifi", "ethernet_lilygo", "ethernet_waveshare", "unknown"]), Tt = /* @__PURE__ */ new Set(["split_phase_120_240", "single_phase_230", "three_phase", "custom"]), dt = /* @__PURE__ */ new Set(["standard", "multi_reference", "custom"]), ht = /* @__PURE__ */ new Set(["grid", "solar", "generator", "subpanel", "branch", "two_pole", "custom", "unused"]), Ii = /* @__PURE__ */ new Set(["direct", "two_ct_sum", "one_ct_double_power", "both_conductors_one_ct"]), Ti = /* @__PURE__ */ new Set(["none", "consumption", "bidirectional", "generation"]), Ri = /* @__PURE__ */ new Set([1, 2, 5, 10, 30, 60]), pt = /* @__PURE__ */ new Set(["config_project", "config_packages", "dashboard_import", "native_project", "native_entity_counts"]), ye = /* @__PURE__ */ new Set(["A", "B", "C"]), Oi = /* @__PURE__ */ new Set(["connecting", "uploading", "writing", "verifying", "completed", "transfer"]), Mi = /* @__PURE__ */ new Set(["write_failed", "write_not_applied", "write_recovery_required", "source_changed", "validation_failed", "validation_unavailable", "compile_failed", "upload_failed", "reconnect_unavailable", "identity_mismatch", "topology_mismatch", "entity_mismatch", "sensor_count_mismatch", "persistence_failed", "rollback_failed", "cancelled"]), Pi = /* @__PURE__ */ new Set(["config_written", "config_validated", "firmware_compiled", "ota_uploaded", "device_verified", "metadata_persisted", "config_restored"]), Ui = /* @__PURE__ */ new Set(["count_mismatch", "invalid_kind", "invalid_unit", "invalid_range", "invalid_step", "unavailable", "zero_ack", "device_busy"]), qi = /* @__PURE__ */ new Set(["config_project", "config_packages", "native_project"]), Di = /^(?:meter|voltage_reference|channel|aggregate|package)\.[a-z0-9_.-]+$/, Ni = /^[0-9a-f]{12}$/, Ee = /^[0-9a-f]{64}$/, Ue = /^[0-9a-f]{32}$/, Bi = /^[a-z0-9](?:[a-z0-9_-]*[a-z0-9])?\.yaml$/, Rt = /^[a-z0-9][a-z0-9_-]{0,127}$/, Ot = /^[0-9]{4}\.[0-9]{1,2}\.[0-9]{1,2}(?:-[A-Za-z0-9.-]+)?$/, ut = /* @__PURE__ */ new Set(["preview_ct_config", "preview_meter_configuration", "preview_calibrated_gains", "apply_ct_config", "compile_ct_config", "install_ct_config", "rollback_ct_config", "subscribe_config_transaction"]), Fi = /* @__PURE__ */ new Set(["available", "unavailable", "invalid"]), zi = /* @__PURE__ */ new Set(["not_started", "in_progress", "completed", "skipped", "partial"]), Hi = /* @__PURE__ */ new Set(["not_started", "in_progress", "completed", "skipped", "partial", "indeterminate"]), Li = /* @__PURE__ */ new Set(["applied_pending_restart_verification", "partial", "indeterminate"]);
function k(n, e) {
...
function be(n, e) {
  const t = k(n, e);
  if (N(t.state, Ai, e), A(t.devices, e).forEach((i) => Mt(i, e)), t.configuration_authoritative !== void 0 && D(t.configuration_authoritative, e), t.bound_device_id !== void 0 && t.bound_device_id !== null && w(t.bound_device_id, e), t.installer_intent !== void 0) {
    ...
    i.power_quality !== void 0 && Pt(i, e, s + 1);
    ...
    if (o === void 0 != (a === void 0) || o !== void 0 && (typeof o != "string" || o.length > 160 || !Rt.test(o)) || a !== void 0 && (typeof a != "string" || a.length > 160 || !Ot.test(a)))
      throw new Error(`${e} response is invalid`);
    if (i.electrical_system === void 0 != (i.line_frequency_hz === void 0) || i.electrical_system !== void 0 && (!Tt.has(i.electrical_system) || ![50, 60].includes(E(i.line_frequency_hz, e))))
      throw new Error(`${e} response is invalid`);
  }
  return n;
}
function De(n, e) {
  ...
  if (new Set(l).size !== l.length || !l.some((c) => qi.has(c))) throw new Error(`${e} response is invalid`);
  return n;
}
function ji(n, e) {
  const t = k(n, e);
  if ("topology" in t) {
    ...
    return t.configuration_authoritative !== void 0 && D(t.configuration_authoritative, e), t.package_options !== void 0 && Pt(t.package_options, e, i.board_count), n;
  }
  return De(n, e);
}
function Vi(n, e) {
  ...
  if (!Ue.test(i) || !Ee.test(w(t.source_sha256, e))) throw new Error(`${e} response is invalid`);
  ...
  const o = k(r.meter, e);
  q(o, ["friendly_name", "electrical_system", "line_frequency_hz", "update_interval_s", "voltage_layout", "voltage_references"], e), w(o.friendly_name, e), N(o.electrical_system, Tt, e);
  const a = E(o.line_frequency_hz, e);
  if (a !== 50 && a !== 60) throw new Error(`${e} response is invalid`);
  const l = E(o.update_interval_s, e);
  if (!Ri.has(l) || !dt.has(N(o.voltage_layout, dt, e))) throw new Error(`${e} response is invalid`);
  const c = A(o.voltage_references, e, 8).map((y) => {
    const $ = k(y, e);
    q($, ["reference_id", "label", "phase_label", "nominal_voltage_v", "transformer_model_id", "gain_voltage", "group_keys"], e);
    const O = L($.reference_id, e), S = w($.label, e);
    w($.phase_label, e);
    const M = U($.nominal_voltage_v, e);
  ...
  g.forEach((y, $) => {
    const O = k(y, e);
    if (q(O, ["channel", "enabled", "name", "model_id", "reporting_multiplier", "role", "voltage_reference_id", "custom_gain_ct", "custom_label", "burden_output_acknowledged"], e), E(O.channel, e) !== $ + 1 || ![1, 2, 4, 8].includes(U(O.reporting_multiplier, e)) || !c.some((I) => I.reference_id === L(O.voltage_reference_id, e))) throw new Error(`${e} response is invalid`);
  ...
  A(r.aggregates, e, 32).forEach((y) => {
    const $ = k(y, e);
    q($, ["aggregate_id", "name", "role", "channels", "measurement_method", "parent_id", "energy_mode", "expose_power", "expose_current"], e);
    ...
    const S = A($.channels, e, 42).map((F) => E(F, e)), M = N($.measurement_method, Ii, e), I = M === "two_ct_sum" ? 2 : M === "one_ct_double_power" || M === "both_conductors_one_ct" ? 1 : void 0;
    ...
    f.set(O, B), N($.energy_mode, Ti, e), D($.expose_power, e), D($.expose_current, e);
  });
  for (const [y, $] of f) {
  ...
  q(_, ["configuration_authoritative", "managed_totals", "multi_reference", "reason_codes"], e), D(_.configuration_authoritative, e), D(_.managed_totals, e), D(_.multi_reference, e), A(_.reason_codes, e, 8).forEach((y) => w(y, e));
  const C = k(t.voltage_topology, e);
  q(C, ["references", "source"], e), N(C.source, /* @__PURE__ */ new Set(["helper", "legacy"]), e);
  ...
  if (q(m, ["presets", "source_repository", "source_ref", "schema_version"], e), w(m.source_repository, e), !/^[0-9a-f]{40}$/.test(w(m.source_ref, e)) || E(m.schema_version, e) !== 1) throw new Error(`${e} response is invalid`);
  const v = A(m.presets, e, 64);
  if (!v.length) throw new Error(`${e} response is invalid`);
  const P = /* @__PURE__ */ new Set();
  v.forEach((y) => {
    const $ = k(y, e);
    q($, ["model_id", "label", "primary_nominal_v", "secondary_nominal_v", "default_gain_voltage", "notes"], e);
    const O = L($.model_id, e);
    if (P.has(O)) throw new Error(`${e} response is invalid`);
    if (P.add(O), w($.label, e), U($.primary_nominal_v, e) <= 0 || U($.secondary_nominal_v, e) <= 0) throw new Error(`${e} response is invalid`);
  ...
  return q(T, ["presets", "source_repository", "source_ref", "schema_version"], e), Ne({ plan_id: t.plan_id, source_sha256: t.source_sha256, channels: t.channels, catalog: t.ct_catalog }, e), A(t.warnings, e, 32).map((y) => w(y, e)), n;
}
function Pt(n, e, t) {
  const i = k(n, e);
...
function Ne(n, e) {
  const t = k(n, e);
  if (q(t, ["plan_id", "source_sha256", "channels", "catalog"], e), w(t.plan_id, e), !Ee.test(w(t.source_sha256, e))) throw new Error(`${e} response is invalid`);
  ...
  i.forEach((o, a) => {
    ...
    w(l.name, e), E(l.raw_gain_ct, e), U(l.reporting_multiplier, e), qe(l.selected_model_id, e), D(l.selection_verified_against_config, e), qe(l.display_label, e), D(l.stored_selection_present, e);
  ...
  q(s, ["presets", "source_repository", "source_ref", "schema_version"], e), w(s.source_repository, e), w(s.source_ref, e), E(s.schema_version, e);
  const r = A(s.presets, e);
  if (r.length > 64) throw new Error(`${e} response is invalid`);
  return r.forEach((o) => {
    const a = k(o, e);
    q(a, ["model_id", "label", "rated_current_a", "secondary", "default_gain_ct", "requires_burden_jumper_cut", "notes"], e), w(a.model_id, e), w(a.label, e), U(a.rated_current_a, e), w(a.secondary, e), a.default_gain_ct !== null && E(a.default_gain_ct, e), D(a.requires_burden_jumper_cut, e), w(a.notes, e);
  }), n;
}
function oe(n, e) {
  const t = k(n, e);
  if (q(t, ["transaction_id", "state", "source_sha256", "changes", "redacted_diff", "rollback_available", "evidence", "progress", "validation_detail", "upload_progress", "aggregate_entity_mismatch", "full_meter_configuration_verified"], e), w(t.transaction_id, e), N(t.state, Ei, e), !Ee.test(w(t.source_sha256, e))) throw new Error(`${e} response is invalid`);
  ...
  }), A(t.evidence, e).forEach((i) => N(i, Mi, e)), A(t.progress, e).forEach((i) => N(i, Pi, e)), t.validation_detail !== null) {
  ...
  return A(t.upload_progress, e).forEach((i) => {
    const s = k(i, e);
    if (q(s, ["stage", "percentage"], e), N(s.stage, Oi, e), s.percentage !== null) {
...
function G(n, e) {
  const t = k(n, e);
  w(t.session_id, e), w(t.device_id, e), N(t.state, xi, e), D(t.safety_acknowledged, e);
  ...
  if (q(r, ["status", "repair_reason"], e), N(r.status, Fi, e) === "invalid") w(r.repair_reason, e);
  else if (r.repair_reason !== null) throw new Error(`${e} response is invalid`);
  const a = N(t.offset_disposition, zi, e), l = A(t.offset_boards, e, 7);
  if (l.length < 1) throw new Error(`${e} response is invalid`);
  const c = [];
  l.forEach((d, g) => {
    const b = k(d, e);
    if (q(b, ["board_index", "stages"], e), E(b.board_index, e) !== g) throw new Error(`${e} response is invalid`);
    const h = A(b.stages, e, 2);
    if (h.length !== 2) throw new Error(`${e} response is invalid`);
    h.forEach((f, _) => {
      const C = k(f, e);
      if (q(C, ["stage", "state"], e), E(C.stage, e) !== _ + 1) throw new Error(`${e} response is invalid`);
      c.push(N(C.state, Hi, e));
    });
  });
...
function Gi(n, e, t, i) {
  const s = k(n, e);
  if (q(s, ["stage", "ready", "connection_generation", "entities", "reasons", "thresholds"], e), E(s.stage, e) !== i || t < 0 || t > 6) throw new Error(`${e} response is invalid`);
  ...
  const l = E(a.sample_count, e), c = U(a.zero_voltage_peak_volts, e), u = U(a.zero_voltage_spread_volts, e), d = U(a.zero_current_peak_amps, e), g = U(a.zero_current_spread_amps, e), b = U(a.voltage_present_minimum_volts, e), h = U(a.voltage_present_spread_volts, e), f = [
    c,
    u,
    d,
    g,
  ...
  _.forEach((M) => {
    const I = k(M, e);
    q(I, ["role", "quantity", "ready", "reasons", "window"], e);
    ...
    if (I.window === null) {
      ...
      q(z, ["values", "received_at", "connection_generation", "mean", "minimum", "maximum", "absolute_peak", "absolute_spread"], e);
      const se = A(z.values, e, l).map((Z) => U(Z, e)), Ie = A(z.received_at, e, l).map((Z) => U(Z, e)), Zt = U(z.mean, e), Te = U(z.minimum, e), Xe = U(z.maximum, e), Re = U(z.absolute_peak, e), me = U(z.absolute_spread, e), Xt = se.reduce((Z, ve) => Z + ve, 0) / se.length, Jt = E(z.connection_generation, e);
      if (se.length !== l || Ie.length !== l || Ie.some((Z, ve) => ve > 0 && Z <= Ie[ve - 1]) || !V(Zt, Xt) || !V(Te, Math.min(...se)) || !V(Xe, Math.max(...se)) || !V(Re, Math.max(...se.map(Math.abs))) || !V(me, Xe - Te)) throw new Error(`${e} response is invalid`);
...
function Ki(n, e, t, i) {
  ...
  const l = a.map((c) => {
    const u = k(c, e), d = A(u.samples, e, 1).map((x) => U(x, e));
    if (d.length !== 1) throw new Error(`${e} response is invalid`);
    const g = U(u.mean, e), b = U(u.standard_deviation, e), h = U(u.range_percent, e), f = d.reduce((x, m) => x + m, 0) / d.length, _ = Math.sqrt(d.reduce((x, m) => x + (m - f) ** 2, 0) / d.length), C = 100 * (Math.max(...d) - Math.min(...d)) / Math.abs(f);
...
function ft(n, e, t) {
  ...
  for (const h of [a, l, c]) h.forEach((f) => U(f, e));
  const u = t.target === "voltage" ? t.groupKey : Ge(t.references[0].channel), d = t.target === "voltage" ? Zi(t.groupKey) : t.references.map((h) => h.channel), g = t.target === "current" && t.references.length === 1 ? ["A", "B", "C"][(t.references[0].channel - 1) % 3] : null, b = D(i.retry_allowed, e);
  ...
  if (s === "indeterminate") {
    ...
    const h = t.target === "voltage" ? l.map(() => t.reference) : t.references.map((C) => C.reference), f = l.map((C, x) => 100 * Math.abs(U(C, e) - h[x]) / h[x]);
    if (c.some((C, x) => U(C, e) < 0 || !V(U(C, e), f[x]))) throw new Error(`${e} response is invalid`);
...
function Yi(n, e, t) {
  ...
  c.forEach((g, b) => {
    ...
    U(h.measured_voltage, e), U(h.measured_current, e);
    const _ = U(h.reference_voltage, e), C = U(h.reference_current, e), x = E(h.old_voltage_gain, e), m = E(h.new_voltage_gain, e), v = E(h.old_current_gain, e), P = E(h.new_current_gain, e);
...
function Be(n, e, t) {
  ...
  if (c && (w(i.config_filename, e), w(i.config_sha256, e), !Bi.test(i.config_filename) || !Ee.test(i.config_sha256)))
    throw new Error(`${e} response is invalid`);
  if (i.config_filename === null != (i.config_sha256 === null)) throw new Error(`${e} response is invalid`);
  if (!Ni.test(i.mac) || !Ue.test(i.verification_id) || r < 1 || i.source_handoff_transaction_id !== null && !Ue.test(i.source_handoff_transaction_id) || s !== t.addon_count || i.topology_project_name !== t.project_name || i.topology_connection_type !== t.connection_type || i.topology_voltage_layout !== t.voltage_layout) throw new Error(`${e} response is invalid`);
...
class Se {
  constructor(e, t) {
    this.hass = e, this.entryId = t, this.setupStatus = () => this.call("setup_status", (i) => be(i, "setup_status")), this.listMeters = () => this.call("list_meters", (i) => (A(i, "list_meters").forEach((s) => Mt(s, "list_meters")), i)), this.getTopology = (i) => this.call("get_topology", (s) => ji(s, "get_topology"), { device_id: i }), this.getCtInventory = (i) => this.call("get_ct_inventory", (s) => Ne(s, "get_ct_inventory"), { device_id: i }), this.getMeterConfiguration = (i) => this.call("get_meter_configuration", (s) => Vi(s, "get_meter_configuration"), { device_id: i }), this.getActiveWork = (i, s) => this.call("get_active_work", (r) => Xi(r, "get_active_work", s), { device_id: i }), this.getSession = (i) => this.call("get_session", (s) => G(s, "get_session"), { session_id: i }), this.getDiagnosticsSummary = () => this.call("get_diagnostics_summary", (i) => k(i, "get_diagnostics_summary")), this.setInstallerIntent = (i, s, r, o, a, l) => this.call("set_installer_intent", (c) => be(c, "set_installer_intent"), {
      ...
      board_index: s,
      stage: r
    }), this.calibrateOffset = (i, s, r, o, a) => this.call("calibrate_offset", (l) => Wi(l, "calibrate_offset", s, r), {
      session_id: i,
      board_index: s,
      stage: r,
...
`) || e.includes("\r"), a = s === "redacted_diff" ? 32768 : 4096;
      if (e.length > a || Ci.test(e) || Si.test(e) || o && s !== "redacted_diff" || s === "redacted_diff" && e.includes("\r"))
...
function es(n, e, t, i, s, r, o, a = !1, l = !1, c = null, u = () => {
}, d = () => {
}) {
  ...
  return p`
    ...
    const f = t.get(h.channel) ?? {
      ...
      expanded: !1
    }, _ = n.catalog.presets.find((m) => m.model_id === f.modelId), C = qt(_, f.multiplier, f.modelId === "custom" ? f.customGainCt : void 0), x = We(h, f);
    return p`
      ...
      <footer class="action-footer">
        <button class="secondary" @click=${r}>Back</button>
        <button class="primary" data-action="continue" ?disabled=${l || !as(n, t, a)} @click=${o}>${l ? "Starting calibration…" : "Continue"}</button>
      </footer>
    </section>
  `;
}
...
function ss(n, e, t) {
  const i = (c, u) => e({
    ...
    c.role === "grid" && c.parent_id !== null ? "A root-grid total must not be included under another aggregate." : "",
    c.measurement_method === "one_ct_double_power" && c.role !== "two_pole" ? `${c.name}: doubled-one-leg measurement is only for a two-pole circuit.` : "",
    c.role === "two_pole" && c.measurement_method === "direct" ? `${c.name}: select a two-pole measurement method.` : ""
  ].filter(Boolean));
  return p`<section class="step-content" aria-labelledby="circuits-heading">
    ...
    ${n.aggregates.map((c, u) => p`<section class="ct-detail" aria-label=${`${c.name} aggregate`}>
      ...
      <label>Method <select aria-label=${`${c.aggregate_id} aggregate method`} .value=${c.measurement_method}
        @change=${(d) => s(u, { measurement_method: d.target.value })}>${ts.map((d) => p`<option value=${d}>${d.replaceAll("_", " ")}</option>`)}</select></label>
      <label>Energy <select aria-label=${`${c.aggregate_id} aggregate energy`} .value=${c.energy_mode}
        @change=${(d) => s(u, { energy_mode: d.target.value })}>${is.map((d) => p`<option value=${d}>${d}</option>`)}</select></label>
      ...
      <button class="secondary" @click=${() => e({ ...n, aggregates: n.aggregates.filter((d, g) => g !== u) })}>Delete aggregate</button>
    </section>`)}
    ${ns(n, a, e)}
  </section>`;
}
function ns(n, e, t) {
  const i = (s, r, o, a, l) => {
    ...
    const u = r.replaceAll("_", "-");
    let d = n.aggregates.length + 1;
    const g = new Set(n.aggregates.map((b) => b.aggregate_id));
    for (; g.has(`${u}-${d}`); ) d++;
    t({ ...n, aggregates: [...n.aggregates, {
      ...
      energy_mode: l,
      expose_power: !0,
      expose_current: r === "grid"
    }] });
  };
  return p`<div class="action-footer"><button class="secondary" ?disabled=${!e.length} @click=${() => i("New aggregate", "branch", "direct", 1, "consumption")}>Add aggregate</button>
    <button class="secondary" ?disabled=${e.length < 2} @click=${() => i("Main service", "grid", "two_ct_sum", 2, "bidirectional")}>Main service</button>
    <button class="secondary" ?disabled=${!e.length} @click=${() => i("Solar", "solar", "direct", 1, "generation")}>Solar</button>
    <button class="secondary" ?disabled=${!e.length} @click=${() => i("Generator", "generator", "direct", 1, "generation")}>Generator</button>
    <button class="secondary" ?disabled=${!e.length} @click=${() => i("Two-pole circuit", "two_pole", "one_ct_double_power", 1, "consumption")}>Two-pole</button>
    <button class="secondary" ?disabled=${e.length < 2} @click=${() => i("Subpanel", "subpanel", "two_ct_sum", 2, "consumption")}>Subpanel</button></div>`;
}
function rs(n, e) {
...
function cs(n, e, t, i, s, r, o, a, l, c, u, d, g, b, h, f) {
...
const ls = [
  ...
  ["custom", "Custom"]
], ds = [1, 2, 5, 10, 30, 60], hs = (n) => n <= 5 ? "1–5 seconds: high traffic." : n === 10 ? "10 seconds: standard." : n >= 30 ? "30–60 seconds: lower traffic; guided calibration takes longer." : "This interval affects update traffic and guided calibration time.";
function ps(n, e, t, i, s, r, o, a, l, c) {
    ...
    <section class="step-content meter-settings-step" aria-labelledby="step-heading">
      ...
      <div class="meter-settings-grid">
        ...
        <label>Electrical system <select aria-label="Electrical system" .value=${n.electrical_system}
          @change=${(h) => s(h.target.value)}>${ls.map(([h, f]) => p`<option value=${h}>${f}</option>`)}</select></label>
        ...
        <label>Reporting interval <select aria-label="Reporting interval" .value=${String(n.update_interval_s)}
          @change=${(h) => g({ update_interval_s: Number(h.target.value) })}>${ds.map((h) => p`<option value=${h}>${h} seconds</option>`)}</select></label>
      </div>
      <p class="info-band" role="status">${hs(n.update_interval_s)}</p>
...
const us = (n) => n === null || typeof n != "object" && typeof n != "function", fs = (n) => n.strings === void 0;
const gs = { CHILD: 2 }, _s = (n) => (...e) => ({ _$litDirective$: n, values: e });
let ms = class {
  constructor(e) {
  }
  get _$AU() {
...
function vs(n) {
  this._$AN !== void 0 ? (Ce(this), this._$AM = n, Bt(this)) : this._$AM = n;
}
function bs(n, e = !1, t = 0) {
...
const ws = (n) => {
  n.type == gs.CHILD && (n._$AP ??= bs, n._$AQ ??= vs);
};
class $s extends ms {
  constructor() {
  ...
  setValue(e) {
    if (fs(this._$Ct)) this._$Ct._$AI(e, this);
    else {
...
const _t = (n) => !us(n) && typeof n.then == "function", mt = 1073741823;
class Cs extends $s {
  constructor() {
    super(...arguments), this._$Cwt = mt, this._$Cbt = [], this._$CK = new ys(this), this._$CX = new Ss();
  }
  render(...e) {
...
const ks = _s(Cs), Ft = "https://circuitsetup.github.io/ESPWebInstaller/", As = new URL("manifests/firmware_index.json", Ft).href, zt = 256 * 1024, Es = 100, xs = 20, Ht = 160, Is = 1e4, Ts = /^[a-z0-9][a-z0-9_-]{0,127}$/, Rs = /^[0-9]{4}\.[0-9]{1,2}\.[0-9]{1,2}(?:-[A-Za-z0-9.-]+)?$/, Lt = /[\u0000-\u001F\u007F-\u009F]/;
function j(n) {
...
function jt(n) {
  if (!Ts.test(n)) throw new Error("Invalid firmware product ID");
}
function Vt(n) {
...
function Os(n) {
  Array.isArray(n) || j("top level must be an array"), Gt(JSON.stringify(n)) > zt && j("payload is too large"), n.length > Es && j("too many products");
  ...
  return n.map((t) => {
    ...
    (!Me(i) || !Me(s) || !Array.isArray(r)) && j("invalid product fields"), jt(i), e.has(i) && j("duplicate product ID"), e.add(i), r.length > xs && j("too many versions");
    const o = /* @__PURE__ */ new Set();
    return {
      productId: i,
      name: s,
      versions: r.map((a) => ((!vt(a) || Object.keys(a).length !== 1 || !Object.hasOwn(a, "version") || !Me(a.version)) && j("invalid version"), Vt(a.version), o.has(a.version) && j("duplicate version"), o.add(a.version), { version: a.version }))
    };
  });
}
async function Ms(n = globalThis.fetch, e) {
  const t = new AbortController(), i = () => t.abort();
  e?.aborted ? i() : e?.addEventListener("abort", i, { once: !0 });
  const s = setTimeout(i, Is);
  try {
    const r = await n(As, { cache: "no-cache", mode: "cors", signal: t.signal });
    if (!r.ok) throw new Error(`Firmware index request failed (${r.status})`);
    const o = await r.text();
    return Gt(o) > zt && j("payload is too large"), Os(JSON.parse(o));
  } finally {
...
let Bs;
const Fs = () => Bs ??= import("./circuitsetup-energy-meter-helper-install-button-DpSoc-pA.js"), bt = (n, e) => p`
...
function zs(n) {
  if (!n) return R;
  try {
    const e = Ns(n.productId, n.version);
...
], Ys = ["(0, 16)", "(27, 17)", "(2, 21)", "(13, 22)", "(14, 25)", "(15, 26)"], Zs = [
  ["split_phase_120_240", "Split phase 120/240 V"],
  ["single_phase_230", "Single phase 230 V"],
  ["three_phase", "Three phase"],
  ["custom", "Custom"]
], yt = (n) => n === "split_phase_120_240" ? 60 : n === "single_phase_230" ? 50 : null;
function Xs(n, e, t, i, s, r, o, a, l = "", c = !1, u = p``, d = null, g = J(e), b = () => {
    ...
    <section class="step-content setup-step" aria-labelledby="step-heading">
      ...
      <section aria-labelledby="jumper-heading">
        ...
        <dl class="summary-band">
          ...
          ${Ys.slice(0, e).map((v, P) => p`<div><dt>Add-on ${P + 1}</dt><dd>${v}</dd></div>`)}
        </dl>
      </section>
      ${u}
...
function Js(n, e, t, i, s, r, o, a, l, c) {
...
function en(n, e, t, i, s = [], r, o, a, l, c, u, d, g, b) {
...
`, le = [
  ...
  ["build", "Flash & Verify"],
  ["summary", "Summary"]
], sn = "circuitsetup.6c-energy-meter", nn = 1e4, rn = 250, St = (n) => new Promise((e) => setTimeout(e, n));
class on extends he {
  constructor() {
  ...
  receiveSetupSnapshot(e, t) {
    const s = e.devices.filter((r) => !this.setupDeviceIds.has(r.entry_id)).sort((r, o) => r.entry_id.localeCompare(o.entry_id)).filter((r) => r.project_name.startsWith(sn));
  ...
  loadFirmwareIndex() {
    ...
    this.firmwareFetchController?.abort(), this.firmwareFetchController = t, this.firmwareCatalogState = "loading", this.firmwareCatalogError = "", this.requestUpdate(), Ms(globalThis.fetch, t.signal).then((i) => {
  ...
  refreshFirmwareOptions() {
    const e = this.firmwareIndex ? qs(this.firmwareIndex, this.addonCount, this.connection) : [], t = this.selectedEspHomeVersion, i = Ds(e, t);
  ...
  setAddonCount(e) {
    this.addonCount = e, this.packageOptions = Vs(this.packageOptions, e), this.sourcePackageOptions = J(e), this.refreshFirmwareOptions();
  }
  ...
  async waitForBinding(e, t, i) {
    ...
    for (; this.ownsOperation(i, e, t); ) {
      ...
      if (Date.now() >= s) break;
      await St(Math.min(rn, s - Date.now()));
    }
    throw new Error("helper rebind timed out");
  }
  async loadTopology() {
  ...
  disableCircuit(e) {
    ...
    const t = this.meterConfiguration.configuration.aggregates.filter((s) => s.channels.includes(e)), i = t.find((s) => {
      const r = s.channels.filter((o) => o !== e).length;
      return !r || s.measurement_method === "two_ct_sum" && r !== 2 || (s.measurement_method === "one_ct_double_power" || s.measurement_method === "both_conductors_one_ct") && r !== 1;
    });
    if (i) {
      this.fail(new Error(), `Repair aggregate ${i.name} before marking CT${e} unused.`);
      return;
    }
    if (t.length && !window.confirm(`Marking CT${e} unused removes it from ${t.map((s) => s.name).join(", ")}. Continue?`)) {
      this.requestUpdate();
      return;
    }
    this.updateCircuitConfiguration({
      ...this.meterConfiguration.configuration,
      channels: this.meterConfiguration.configuration.channels.map((s) => s.channel === e ? { ...s, enabled: !1, role: "unused" } : s),
      aggregates: this.meterConfiguration.configuration.aggregates.map((s) => ({
        ...s,
        channels: s.channels.filter((r) => r !== e)
      }))
    });
  }
  hasPackageChanges() {
  ...
  async continueFromCt() {
    ...
    if (this.meterConfiguration && !this.labelOnly && this.canonicalConfigurationChanged) {
      ...
      if (!rs(t, this.inventory.channels.length))
  ...
  stepBody() {
    return this.step === "setup" ? p`${Xs(
    ...
    ) : R}` : this.step === "meter" && this.meterSettingsDraft && this.meterConfiguration ? ps(
      this.meterSettingsDraft,
      ...
      this.voltageSkipped = !0, this.announcement = "Remaining voltage calibration was skipped; completed gains were preserved.", this.requestUpdate();
        ...
        <button class="primary" ?disabled=${this.voltageBusy || !this.voltageSkipped && !this.hasCompletedCalibration("voltage")} @click=${() => this.navigate("current")}>Continue</button></footer>` : this.step === "current" ? p`${cs(
      this.topology,
      this.inventory,
      this.session,
      this.channel,
      ...
      this.finishCurrent();
    }}>${this.finishBusy ? "Finishing…" : "Continue"}</button></footer>` : this.step === "restart" ? Gs(
  ...
  firmwareCatalog() {
    ...
    return p`<section class="step-content" aria-labelledby="firmware-heading">
      ...
      ${this.firmwareCatalogState === "ready" ? zs(this.selectedFirmware()) : R}
    </section>`;
  }
  render() {
...
customElements.get("circuitsetup-energy-meter-helper-panel") || customElements.define("circuitsetup-energy-meter-helper-panel", on);
export {
  on as CircuitSetupPanel
};
