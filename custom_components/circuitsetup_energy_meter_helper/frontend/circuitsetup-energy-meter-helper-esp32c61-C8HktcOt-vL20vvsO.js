...
class _ extends s {
  ...
  async getChipDescription(E) {
    let _2;
    _2 = 0 === await this.getPkgVersion(E) ? "ESP32-C61" : "unknown ESP32-C61";
  ...
  async readMac(E) {
    let _2 = await E.readReg(this.MAC_EFUSE_REG);
    _2 >>>= 0;
    let S = await E.readReg(this.MAC_EFUSE_REG + 4);
    S = S >>> 0 & 65535;
    const t = new Uint8Array(6);
    return t[0] = S >> 8 & 255, t[1] = 255 & S, t[2] = _2 >> 24 & 255, t[3] = _2 >> 16 & 255, t[4] = _2 >> 8 & 255, t[5] = 255 & _2, this._d2h(t[0]) + ":" + this._d2h(t[1]) + ":" + this._d2h(t[2]) + ":" + this._d2h(t[3]) + ":" + this._d2h(t[4]) + ":" + this._d2h(t[5]);
  }
}
export {
  _ as ESP32C61ROM
